...
namespace PongGame
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            PaddleBottom.Position = new Vector2(250,screenBounds.Height-PaddleBottom.Size.Height); 
            PaddleTop.Position = new Vector2(250,1);//isprobaj neke druge na kraju!!!!!
            ...
            SoundEffect.MasterVolume = 0.1f;//da ne bude preglasno
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            //granice u kojima reket može stajati
            var bounds = graphics.GraphicsDevice.Viewport.Bounds; //za kraće pisanje
            ...
            if (Ball.Position.Y > bounds.Bottom || Ball.Position.Y < bounds.Top) 
            {
                ...
                {
                    //uvećaj rezultat gornjeg igrača
                }
                else if (Ball.Position.Y < bounds.Top) 
                {
                    //uvećaj rezultat donjeg igrača
                }
